            ...
            Container(
              ...
              child: Padding(
                ...
                child: ReUseAbleText(
                  ...
                  style: appstyle(28, Colors.white, FontWeight.bold),
                ),
              ),
            ),
            Padding(
                padding: EdgeInsets.only(
                    left: 8.w, right: 8.w, top: 20.h, bottom: 8.h),
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          //         (element) => element == meal['id']);
                                          favoritesNotifier.names.removeWhere(
                                                  (element) => element == meal['name']);
                                        });
                                        if(favoritesNotifier.names.isEmpty){
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) =>
